...
describe('UpDownVoteController', function () {
    ...
    beforeEach(inject(function ($rootScope, $controller) {
        ...
        $controller('UpDownVoteController', { $scope: scope, ngDialog: mockngDialog });
    }));
    ...
    describe('VoteCallback called', function () {
        ...
        it('VoteValue positive is set correctly', function () {
            var option = [{
                Id: 35,
                voteValue: 1
            }];
        ...
        it('VoteValue negative is set correctly', function () {
            var option = [{
                Id: 35,
                voteValue: -1
            }];
