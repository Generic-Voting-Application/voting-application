...
namespace VotingApplication.Web.Tests.Validators
{
    ...
    public class BasicVoteValidatorTests
    {
        ...
        {
            // Arrange
            List<VoteRequestModel> votes = new List<VoteRequestModel> { new VoteRequestModel { VoteValue = 2, OptionId = 2 },
        ...
        {
            // Arrange
            List<VoteRequestModel> votes = new List<VoteRequestModel> { new VoteRequestModel { VoteValue = 0, OptionId = 1 } };
